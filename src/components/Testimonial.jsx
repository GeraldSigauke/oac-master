  ...
  return (
    <>
      <div class="mb-0 pb-3">
        ...
        <h5 id="text2" class="text-lg font-bold mb-4 text-[#120245]">{ testimonial.name }</h5>
        <h6 id="text3" class="font-medium mb-4">{ testimonial.profession }</h6>
        <p id="text8" class="mb-4">
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fas"
